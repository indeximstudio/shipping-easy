...
class ApiRequester
{
    ...
    public function handleApiError($rbody, $rcode, $resp)
    {
        ...
        switch ($rcode) {
            case 400:
                throw new InvalidRequestError(json_encode($error), $rcode, $rbody, $resp);
            case 404:
                throw new InvalidRequestError($message, $rcode, $rbody, $resp);
            case 401:
                throw new AuthenticationError($message, $rcode, $rbody, $resp);
            default:
                throw new ApiError($message, $rcode, $rbody, $resp);
        }
    }
